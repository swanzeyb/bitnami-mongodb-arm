# MongoDB&reg; packaged by Bitnami for ARM64 systems

## Bitnami's MongoDB Image For Apple M1 / Raspberry Pi 4, or any ARM64 system ##
This repo is a fork of Bitnami's MongoDB 5.X version, which can be used in the same exact way as Bitnami's instructions specify.
It works by using pre-compiled bin packages. GOSU and YQ binaries were sourced from their github repositories.
RENDER-TEMPLATE and WAIT-FOR-PORT were compiled by me, on an Apple M1 macine.

This package removes the checksum checks performed by Bitnami's script, for best security - consider compiling your own binaries.
I'd recommend using this repo and Docker image only in Development & Testing environments.

Star this repository if you found it helpful. Not what you expected? Please open an issue.
